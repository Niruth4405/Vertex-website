...
function Founders() {
  return (
    <div id="members" className='max-w-[1000px] mx-auto px-5'>
      ...
      <div className='flex flex-col justify-center items-center md:flex-row md:gap-8 md:justify-center md:items-center'>{founders.map((d)=>(
